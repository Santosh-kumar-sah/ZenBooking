...
const BookingCalendar = ({ availableSlots = [], onDateSelect, selectedDate }) => {
  ...
  return (
    <Card className="p-5">
      ...
      <div className="mb-2 grid grid-cols-7 gap-2 text-center text-xs uppercase tracking-[0.2em] text-slate-500">
          ...
          return (
            <button
              ...
              className={[
                ...
                disabled ? 'cursor-not-allowed text-slate-600' : 'text-white hover:ring-2 hover:ring-primary-500/40',
                selected ? 'bg-gradient-to-r from-primary-500 to-accent-500 text-white ring-2 ring-primary-500/40' : 'bg-white/5',
